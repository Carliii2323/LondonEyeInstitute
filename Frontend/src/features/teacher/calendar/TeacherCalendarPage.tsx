...
/* ============================================================
 * TeacherCalendarPage — Calendario del docente (solo lectura)
 *
 * Eventos generales + los de sus cursos (GET /calendar/events,
 * el backend filtra por rol/cursos del docente).
 * ============================================================ */
    ...
    <PageContainer title="Calendario">
      ...
      <div className="bg-white rounded-card shadow-card overflow-hidden">
        ...
        <div className="px-5 pb-4 text-center">
          <p className="text-small text-surface-400 italic">El calendario es gestionado por administracion. Solo lectura.</p>
        </div>
      </div>
    </PageContainer>
  )
